    ...
    function AIAssistantPlugin() {
        ...
        this.requestGemini = function (prompt, keys, modelIdx, useGrounding, onSuccess, onNextProvider) {
            ...
            var tryKey = function () {
                ...
                .then(function (r) { return r.json().then(function (j) { return { status: r.status, ok: r.ok, data: j }; }); })
                .then(function (res) {
        ...
        this.requestOpenRouter = function (prompt, key, modelIdx, onSuccess, onAllFailed) {
            ...
            .catch(function () { _this.requestOpenRouter(prompt, key, modelIdx+1, onSuccess, onAllFailed); });
        };
        ...
        this.buildFactsPrompt = function (ctx) {
            return 'Imagine you are telling a friend fascinating things about the ' + ctx.type +
                ' "' + ctx.original_title + '" (' + ctx.year + '). Language: Ukrainian.\n\n' +
                'CRITICAL HONESTY RULE: If you are not 100% sure about a fact — DO NOT include it.\n' +
                'Better 3 verified facts than 7 invented ones. Never invent names, locations, or\n' +
                'details that sound plausible but you do not actually know.\n\n' +
                'Share up to 7 facts that will genuinely surprise an average viewer:\n' +
                '- Funny or dramatic stories from the set\n' +
                '- Real-life inspiration for characters or events\n' +
                '- Famous scenes that almost did not happen\n' +
                '- Surprising connection to other films or real events\n' +
                '- Something about the actors or director that will amaze fans\n\n' +
                'FORBIDDEN: release date, award lists, budget numbers, invented names.\n' +
                'Write in a lively, enthusiastic style like telling a friend.\n\n' +
                'Respond ONLY with JSON array:\n' +
                '[{"title":"Short catchy title","text":"2-3 sentences in lively style"}]';
        };
        ...
        this.buildRecapPrompt = function (itemTitle, franchiseTitle, year) {
            return 'You are a viewer recapping "' + itemTitle + '" (' + franchiseTitle + ', ' + year + ') for a friend. Language: Ukrainian.\n\n' +
                'CRITICAL RULE: Recap ONLY the REAL plot of this work.\n' +
                'If you do not know the exact plot of "' + itemTitle + '" — return only:\n' +
                '[{"point":"\u041d\u0430 \u0436\u0430\u043b\u044c, \u0434\u0435\u0442\u0430\u043b\u044c\u043d\u0430 \u0456\u043d\u0444\u043e\u0440\u043c\u0430\u0446\u0456\u044f \u043f\u0440\u043e \u0441\u044e\u0436\u0435\u0442 \u043d\u0435\u0434\u043e\u0441\u0442\u0443\u043f\u043d\u0430."}]\n' +
                'NEVER invent characters, events, or names that do not exist in the original.\n\n' +
                'If you know it — write 10 short points WHAT HAPPENED.\n' +
        ...
        this.processAiList = function (list, callback) {
            ...
            var finish = function () {
                if (finished) return;
                finished = true;
                dbg.log('processAiList: found ' + results.length + ' of ' + total);
                callback(results);
            };
                ...
                success: function (res) {
                    try {
                        ...
                        tags.forEach(function(tag, idx) {
                            if (arr[idx]) tag.name = arr[idx].replace(/(\u043f\u043e\u0437\u043d\u0430\u0447\u043a\u0430|\u0442\u0435\u0433) \u0434\u043e \u0444\u0456\u043b\u044c\u043c\u0443[:\s]*/gi,'').replace(/movie tag[:\s]*/gi,'').replace(/^[:\s\-]*/,'').trim();
                        });
                        callback(tags);
